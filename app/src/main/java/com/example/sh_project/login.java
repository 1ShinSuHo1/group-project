            ...
            public void onClick(View v) {
                ...
                call.enqueue(new Callback<LoginResponse>() {
                        ...
                        if (response.isSuccessful()) {  // 서버에서 응답이 정상적일 때
                            ...
                            if (loginResponse != null) {
                                ...
                                if (loginResponse.getStatus().equals("success")) {
                                    ...
                                    // 일정 시간 후에 function.java로 이동
                                    loginButton.postDelayed(new Runnable() {
                                        @Override
                                        public void run() {
                                            Intent intent = new Intent(login.this, function.class);  // 로그인 후 이동할 화면
                                            startActivity(intent);
                            ...
                            Toast.makeText(login.this, "로그인 실패. 정보가 일치하지 않습니다", Toast.LENGTH_SHORT).show();
                        }
                    }
                    ...
                    public void onFailure(Call<LoginResponse> call, Throwable t) {
                        ...
                        Toast.makeText(login.this, "네트워크 오류가 발생했습니다.", Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
